 ...
 * @LastEditTime: 2024-01-23 13:41:48
 * @FilePath: \src\pages\waterEnvStatus\components\ModuleLeftBar\components\waterEnv\waterQualityRanking.vue
 * @Description:
-->
<template>
  <section class="surface-water-section">
    ...
    <section class="content">
      <div class="row special">
        ...
        <div class="col col2">区县市</div>
        <div class="col col3"></div>
        <div class="col col4">CWQI</div>
      </div>
      <div class="list-container" ref="rankingRef" @mouseenter="clear" @mouseleave="autoScroll">
        <div class="ranking-list">
          <div class="row list-row" v-for="item in dataList" :key="item.index">
            ...
            <div class="col col3">
              <a-slider v-model:value="item.value" :min="0" :max="10" :step="0.1" disabled />
            </div>
            <div class="col col4 dark">{{ item.value }}</div>
          </div>
        </div>
      </div>
    </section>
