 ...
 * @LastEditTime: 2024-02-01 15:04:03
 * @FilePath: \src\pages\waterEnvStatus\components\ModuleRightBar\components\importantPollution\polluteWaterDeal.vue
 * @Description:
-->
<template>
  <section class="pollute-water-deal">
    <CommonModuleHeader title="城镇污水处理厂情况"> </CommonModuleHeader>
    <section class="content">
      <section class="row">
        <section class="left">
          <CommonSubHeader title="城镇污水处理厂基本情况" textAlign="left" />
          <section class="list">
            <section class="block">
              ...
              <section class="block-half">
                ...
                <span class="value"
                  >{{ pollutionNums[1]?.value }}
                  <div class="unit2">万吨</div></span
                >
              </section>
            </section>
          </section>
        ...
        <section class="right">
          ...
          <section class="chart-container">
            <LightRingChart
              chartID="pollute-water-deal-chart"
