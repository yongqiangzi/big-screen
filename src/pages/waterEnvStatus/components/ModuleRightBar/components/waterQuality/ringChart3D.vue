 ...
 * @LastEditTime: 2024-01-22 16:41:32
 * @FilePath: \src\pages\waterEnvStatus\components\ModuleRightBar\components\waterQuality\ringChart3D.vue
 * @Description:
-->
<template>
  ...
  <div class="legend-list">
    ...
    >
      <div :class="['item-icon-right', `icon-${item.type}`]"></div>
      {{ item.name }}
    </div>
  </div>
</template>
