 ...
 * @LastEditTime: 2024-01-30 10:03:26
 * @FilePath: \src\components\Chart\barChart.vue
 * @Description:
-->
<template>
  <div
...
const props = defineProps(['chartId', 'seriesName', 'xAxisData', 'pieChartData', 'chartStyle']);
